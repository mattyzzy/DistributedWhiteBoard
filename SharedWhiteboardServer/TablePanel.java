        ...
        delButton.addActionListener(new ActionListener(){//add action listener
            public void actionPerformed(ActionEvent e){
                ...
                if(selectedRow!=-1)  
                {
                    ...
                    try {
                        OutputStream ous = Myserver.list.get(selectedRow).socket.getOutputStream();
                        ...
                        dos.writeUTF("hhh");
                        dos.flush();
                        Myserver.list.get(selectedRow).socket.close();
                        Myserver.username.remove(selectedRow);
                    }
                    ...
                    Myserver.list.remove(selectedRow);
                }
            }
        });
